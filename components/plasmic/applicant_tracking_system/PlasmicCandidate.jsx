...
import sty from "./PlasmicCandidate.module.css"; // plasmic-import: nuvcWWnzr597/css
  ...
  const new$Queries = {
    positions: usePlasmicDataOp(() => {
      return {
        ...
        opId: "e304575d-b5d9-403c-abaf-de9a152dbef4",
        userArgs: {},
        cacheKey: `plasmic.$.e304575d-b5d9-403c-abaf-de9a152dbef4.$.`,
    ...
    candidate: usePlasmicDataOp(() => {
      return {
        sourceId: "b9cEzjYg4TNCDPqLqLqqkA",
        opId: "69427c29-5c2d-4c26-9f9b-6a9b22ea133f",
        userArgs: {
          filters: [$ctx.params.id]
        },
        cacheKey: `plasmic.$.69427c29-5c2d-4c26-9f9b-6a9b22ea133f.$.`,
        invalidatedKeys: null,
        roleId: "837ba888-13d4-40e3-86a6-ea0232127734"
      };
    })
                        ...
                        $steps["tutorialdbUpdateMany"] = true
                          ? (() => {
                              const actionArgs = {
                                dataOp: {
                                  sourceId: "b9cEzjYg4TNCDPqLqLqqkA",
                                  opId: "7bc0cb9e-b65f-4c64-a151-4e614bd5b5c6",
                                  userArgs: {
