...
import sty from "./PlasmicNewCandidate.module.css"; // plasmic-import: Bky2rnZRoBFo/css
  ...
  const new$Queries = {
    positions: usePlasmicDataOp(() => {
      return {
        ...
        opId: "ea545bd4-f2a1-4397-b54d-4e5866fe25da",
        userArgs: {},
        cacheKey: `plasmic.$.ea545bd4-f2a1-4397-b54d-4e5866fe25da.$.`,
                        ...
                        $steps["postgresCreate"] = true
                          ? (() => {
                              const actionArgs = {
                                dataOp: {
                                  sourceId: "b9cEzjYg4TNCDPqLqLqqkA",
                                  opId: "6ea50937-c482-451f-8382-3a7d8eb455d8",
                                  userArgs: {},
                                  cacheKey: null,
