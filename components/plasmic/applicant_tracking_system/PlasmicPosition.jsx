...
import Card from "../../Card"; // plasmic-import: JM53y4BoIh4L/component
...
import sty from "./PlasmicPosition.module.css"; // plasmic-import: fj_-fM07xuP9/css
  ...
  const new$Queries = {
    position: usePlasmicDataOp(() => {
      return {
        ...
        opId: "f3b8aadd-b8c1-4c04-b1ee-ec2bdaa7f009",
        userArgs: {
          filters: [$ctx.params.id]
        },
        cacheKey: `plasmic.$.f3b8aadd-b8c1-4c04-b1ee-ec2bdaa7f009.$.`,
    ...
    candidates: usePlasmicDataOp(() => {
      return {
        sourceId: "b9cEzjYg4TNCDPqLqLqqkA",
        opId: "bbda3623-02cc-4dd8-be46-a098169c7187",
        userArgs: {
          filters: [$ctx.params.id]
        },
        cacheKey: `plasmic.$.bbda3623-02cc-4dd8-be46-a098169c7187.$.`,
        invalidatedKeys: null,
        roleId: "837ba888-13d4-40e3-86a6-ea0232127734"
      };
    })
            ...
            <DataCtxReader__>
              {$ctx => (
                ...
                >
                        ...
                        $steps["tutorialdbUpdateMany"] = true
                          ? (() => {
                              const actionArgs = {
                                dataOp: {
                                  sourceId: "b9cEzjYg4TNCDPqLqLqqkA",
                                  opId: "65f27550-f717-4c87-86f2-6d6c915c55b5",
                                  userArgs: {
                  ...
                  <Card
                    className={classNames("__wab_instance", sty.card__iQnG7)}
                    noTitle={true}
                  >
                    <RichDetails
                  ...
                  <Card
                    className={classNames("__wab_instance", sty.card__yqH8P)}
                    title={
                      <h4
