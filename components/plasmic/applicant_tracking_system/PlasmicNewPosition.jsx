...
import sty from "./PlasmicNewPosition.module.css"; // plasmic-import: 5skJmfMn0N-t/css
  ...
  const new$Queries = {
    depts: usePlasmicDataOp(() => {
      return {
        ...
        opId: "87076d62-79dc-4534-9939-679fa1c0add5",
        userArgs: {},
        cacheKey: `plasmic.$.87076d62-79dc-4534-9939-679fa1c0add5.$.`,
                        ...
                        $steps["tutorialdbCreate"] = true
                          ? (() => {
                              const actionArgs = {
                                dataOp: {
                                  sourceId: "b9cEzjYg4TNCDPqLqLqqkA",
                                  opId: "a8ad30cd-464d-4e17-9efb-7ce22986a0cc",
                                  userArgs: {},
                                  cacheKey: null,
